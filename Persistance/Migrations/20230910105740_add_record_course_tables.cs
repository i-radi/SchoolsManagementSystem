...
{
    /// <inheritdoc />
    public partial class add_record_course_tables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForTeachers = table.Column<bool>(type: "bit", nullable: false),
                    ForStudents = table.Column<bool>(type: "bit", nullable: false),
                    SchoolId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Records_Schools_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "Schools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecordClasses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecordClasses_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecordClasses_Records_RecordId",
                        column: x => x.RecordId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecordClasses_ClassroomId",
                table: "RecordClasses",
                column: "ClassroomId");

            migrationBuilder.CreateIndex(
                name: "IX_RecordClasses_RecordId",
                table: "RecordClasses",
                column: "RecordId");

            migrationBuilder.CreateIndex(
                name: "IX_Records_SchoolId",
                table: "Records",
                column: "SchoolId");
